/* PrismJS 1.30.0
https://prismjs.com/download#themes=prism-coy&languages=markup+css+clike+javascript+css-extras+git+graphql+ini+json+markdown+markup-templating+parser+php+plant-uml+powershell+python+ruby+sql&plugins=line-highlight+line-numbers+show-language+normalize-whitespace+toolbar+copy-to-clipboard+download-button+treeview */
